...
psed_tratado <- psed_tratado %>%  
  select(AG2, AH1_1, AH2_1, AH6_1, AH11_1,AH12_1, AH13_1,
         AQ4_1, AQ5_1, AQ6_1, AQ7_1, AQ8_1, AQ9_1, AQ10_1, AQ12x, 
         BQ4_1, BQ5_1, BQ6_1, BQ7_1, BQ8_1, BQ9_1, BQ10_1, BQ12x, 
         CQ4_1, CQ5_1, CQ6_1, CQ7_1, CQ8_1, CQ9_1, CQ10_1, CQ12x,
         DQ4_1, DQ5_1, DQ6_1, DQ7_1, DQ8_1, DQ9_1, DQ10_1, DQ12x,
         EQ4_1, EQ5_1, EQ6_1, EQ7_1, EQ8_1, EQ9_1, EQ10_1, EQ12x,
         AR4,BR4,CR4,DR4,ER4, AS5,ES5, AS8, AS9, AS10, ES8, ES9, ES10,
...
psed_tratado <- psed_tratado%>% 
  ...
  rename(idade = AH2_1, industria = AH11_1, empreendedorismo = AH12_1,
         ...
         internacional_a = AS10, internacional_e = ES10)
...
Vamos criar variáveis considerando a fonte de financiamento: resersas pessoais, 3F (family, friends and fools), crédito e equity. 
...
Renomeando a variável sobre normas sociais
```{r}
psed_tratado <- psed_tratado %>% 
                  rename(suporte_comunidade = AP1, autonomia = AP2, risco = AP3,
                         criatividade = AP4, gestao_vida = AP5, empreendedorismo_jovens = AP6,
                         suporte_gov_local = AP7, suporte_bancos = AP8, 
                         suporte_grupos = AP9, amigos_empreendem = AP10, 
                         familiares_empreendem = AP11, lideres = AP12)
...
```{r select}
psed_tratado <- psed_tratado %>% 
  select(sexo,idade,escolaridade,industria,empreendedorismo,negocios_possui,personal_savings_A,
         personal_savings_B,personal_savings_C,ps_acumulado_B,ps_acumulado_C,fff_A,fff_B,fff_C,
         fff_acumulado_B,fff_acumulado_C,credit_A,credit_B,credit_C,credit_acumulado_B,
         credit_acumulado_C,pesq_desenv_a,pesq_desenv_e,regional_a,nacional_a,internacional_a,
         regional_e,nacional_e,internacional_e,suporte_comunidade, autonomia, risco, criatividade,
         gestao_vida, empreendedorismo_jovens, suporte_grupos, amigos_empreendem,
         familiares_empreendem, lideres) %>% 
  filter(idade < 99) %>% 
  filter(industria < 98) %>% 
